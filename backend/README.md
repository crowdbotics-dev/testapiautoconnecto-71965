...
## Project Structure
    ...
    ├── testapiautoconnecto_71965  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_71965`
...
2. Clone this repo and `cd testapiautoconnecto_71965`
